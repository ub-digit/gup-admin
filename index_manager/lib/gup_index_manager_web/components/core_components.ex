defmodule GupIndexManagerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GupIndexManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GupIndexManagerWeb.Gettext, "errors", msg, opts)
    end
  end

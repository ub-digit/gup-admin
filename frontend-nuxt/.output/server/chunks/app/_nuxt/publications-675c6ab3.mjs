import { ref, withAsyncContext, withCtx, unref, createVNode, toDisplayString, useSSRContext, defineComponent, onUnmounted, watch, openBlock, createBlock, createCommentVNode, createTextVNode } from 'vue';
import { h as defineStore, u as useI18n, d as useRoute, b as useRouter, s as storeToRefs, g as __nuxt_component_4, a as _export_sfc, i as useHead, e as __nuxt_component_0$2 } from '../server.mjs';
import { u as useFetch, _ as __nuxt_component_0 } from './Spinner-cea46663.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderAttr } from 'vue/server-renderer';
import { a as useImportedPostsStore, u as useFilterStore, b as useDebounceFn } from './imported_posts-1f7e588c.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/ssr';
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="mb-0" data-v-a99a7e19${_scopeId}>${ssrInterpolate(__props.post.date)}</p><small data-v-a99a7e19${_scopeId}>Pubtype: ${ssrInterpolate(__props.post.pubtype)}<br data-v-a99a7e19${_scopeId}> ${ssrInterpolate(__props.post.number_of_authors)} f\xF6rfattare</small>`);
          } else {
            return [
...
//# sourceMappingURL=publications-675c6ab3.mjs.map
